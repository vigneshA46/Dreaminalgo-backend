...
export const getUserDeployedStrategies = async (req, res) => {
  try {
    ...
    console.error(
      "Error fetching deployed strategies with pnl:",
      error
    );
...
// ============================================================
// GET DEPLOYMENTS BY STRATEGY - DETAILED
// ============================================================
...
export const getDeploymentsByStrategyDetailed = async (req, res) => {
  try {
    ...
    console.error(
      "Error fetching strategy deployments:",
      error
    );
...
// ============================================================
// GET DEPLOYMENTS BY BROKER - DETAILED
// ============================================================
...
export const getDeploymentsByBrokerDetailed = async (req, res) => {
  try {
    ...
    console.error(
      "Error fetching broker deployments:",
      error
    );
...
// ============================================================
// GET DEPLOYMENTS BY USER - DETAILED
// ============================================================
...
export const getDeploymentsByUserDetailed = async (req, res) => {
  try {
    ...
    console.error(
      "Error fetching user deployments:",
      error
    );
...
// ============================================================
// GET DEPLOYMENTS BY DATE - DETAILED
// ============================================================
...
export const getDeploymentsByDateDetailed = async (req, res) => {
  try {
    const result = await pool.query(`
      WITH date_summary AS (
        SELECT
          ...
          -- CONVERT UTC -> IST BEFORE TAKING DATE
          DATE(
            d.deployed_at
            AT TIME ZONE 'UTC'
            AT TIME ZONE 'Asia/Kolkata'
    ...
    console.error(
      "Error fetching deployments by date:",
      error
    );
...
// ============================================================
// GET DEPLOYMENTS BY SPECIFIC DATE
// ============================================================
...
export const getDeploymentsByDate = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      ...
      WHERE
        d.deployed_at AT TIME ZONE 'UTC'
        AT TIME ZONE 'Asia/Kolkata'
        BETWEEN $1::date
        AND $1::date
            + interval '1 day'
